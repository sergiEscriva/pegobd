...
class SharedPreferencesHelper {
  ...
  static Future<void> saveVehicleSensors(String deviceAddress, List<String> sensorPids) async {
    final prefs = await SharedPreferences.getInstance();
  ...
  static Future<void> saveLastConnectedDevice(String deviceAddress, String deviceName) async {
    final prefs = await SharedPreferences.getInstance();
    final deviceData = {
