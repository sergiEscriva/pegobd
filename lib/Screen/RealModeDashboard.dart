...
class RealModeDashboard extends StatefulWidget {
  ...
  const RealModeDashboard({required this.connectionManager});

  @override
  State<RealModeDashboard> createState() => _RealModeDashboardState();
}

class _RealModeDashboardState extends State<RealModeDashboard> {
